...
-- buffer management
keymap.set("n", "<leader>bx", ":bd<CR>", { desc = "Close current buffer" }) -- close current tab
keymap.set("n", "<leader>bh", ":bp<CR>", { desc = "Go to buffer on the left" }) -- close current tab
keymap.set("n", "<leader>bl", ":bn<CR>", { desc = "Go to buffer on the right" }) -- close current tab
